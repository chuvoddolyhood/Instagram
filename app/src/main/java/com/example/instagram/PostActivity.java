...
//                startActivity(new Intent(PostActivity.this, MainActivity.class));
    ...
    //Open view "Chon nguon" so that choose image from gallery or camera or source file
    //If choosed image, it will enter to view croped-image
    //Else exit
    @Override
    ...
    private void anhXa() {
        image_close = findViewById(R.id.img_close);
